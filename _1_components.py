...
def build_navbar(active_path: str) -> dbc.Navbar:
    ...
    left_group = [
        ...
        dbc.Button(
            ...
            className="mb-2 me-2",
            size="sm",
            href="https://github.com/gilmore307/mBatchNet/issues",
            target="_blank",
            style={"width": "150px"},
        ),
    ]
    ...
    right_group = [
        ...
        dbc.Button(
            [html.I(className="bi bi-file-earmark-arrow-down me-1"), "Download outputs"],
        ...
        dbc.Button(
            [html.I(className="bi bi-file-zip me-1"), "Repro bundle"],
            id="download-reproducibility-btn",
            color="light",
            outline=True,
            className="mb-2 ms-2",
            size="sm",
