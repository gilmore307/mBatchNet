    ...
    def _register_group(stage: str, key: str, script_name: str, title: str):
        ...
        def _run_one(
            ...
            *values,
            ...
            refresh_phase = run_state_payload.get("refresh_phase", "render")
            ...
            if not run_state_payload.get("complete"):
                ...
                run_state_payload["refresh_remaining"] = 3
                run_state_payload["refresh_phase"] = "blank"
                refresh_remaining = 3
                refresh_phase = "blank"

            if refresh_remaining > 0:
                if refresh_phase == "blank":
                    content = html.Div()
                    run_state_payload["refresh_phase"] = "render"
                    poll_disabled = False
                else:
                    content = render_group_tabset(session_dir, _stage, _key)
                    refresh_remaining -= 1
                    run_state_payload["refresh_remaining"] = refresh_remaining
                    run_state_payload["refresh_phase"] = "blank" if refresh_remaining > 0 else "done"
            ...
            run_state_payload["refresh_phase"] = "done"
            run_state_payload["refresh_remaining"] = 0
            poll_disabled = True
            run_button_disabled = False
