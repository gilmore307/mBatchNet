...
# --- Build phenotype (binary 0/1) from 'cancer' or 'outcome' ---
...
# --- Select covariate columns: remove batch / cancer / outcome ---
covar_cols <- setdiff(colnames(pheno), c("batch", "cancer", "outcome"))
