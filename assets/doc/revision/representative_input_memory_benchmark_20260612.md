...
The ConQuR-derived and PLSDAbatch FullData inputs were generated from the example-data scripts/object layouts in `assets/example` and then validated against the current public upload contract.
...
- All three tested inputs completed all 12 supported correction methods successfully.
...
- The `assets/example/data_metadict.R` script attempted package installation and was not used as a benchmark input generator in this run.
