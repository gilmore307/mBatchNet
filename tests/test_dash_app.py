...
class DashAppTests(unittest.TestCase):
    ...
    def test_upload_layout_contains_original_example_flow(self):
        ...
        self.assertNotIn("mBatchNet reports a warning when batch and target are strongly associated", text)
    ...
    def test_help_modal_documents_preprocess_validation(self):
        ...
        self.assertIn("Blocks", toc_text)
        self.assertIn("Warnings", toc_text)
        ...
        self.assertIn("Method availability warnings", text)
