...
class DashAppTests(unittest.TestCase):
    ...
    def test_upload_layout_contains_original_example_flow(self):
        ...
        self.assertIn("Accepted input", text)
        self.assertIn("Metadata", text)
        self.assertIn("Public server limits", text)
        self.assertIn("Validation warnings", text)
        ...
        self.assertIn("Samples: 1000", text)
        self.assertIn("Features: 1000", text)
        self.assertIn("CSV size: 10.0 MB per uploaded CSV", text)
        self.assertIn("Matrix cells: 1,000,000", text)
