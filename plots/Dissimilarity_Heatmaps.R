...
fig_dims_ait <- apply_fig_overrides(w_ait, h_ait, 600, panel_cols_ait, panel_rows_ait)
...
fig_dims_bc <- apply_fig_overrides(w_bc, h_bc, 600, panel_cols_bc, panel_rows_bc)
