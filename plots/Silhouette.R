...
if (only_baseline) {
  ...
  ggsave(file.path(output_folder, "silhouette.png"), p_sil, width = dims$width, height = dims$height, dpi = PLOT_DPI)
  ggsave(file.path(output_folder, "silhouette.tif"), p_sil, width = dims$width, height = dims$height, dpi = PLOT_DPI, compression = "lzw")
